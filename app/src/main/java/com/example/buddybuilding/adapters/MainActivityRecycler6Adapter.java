...
public class MainActivityRecycler6Adapter extends RecyclerView.Adapter<MainActivityRecycler6Adapter.CustomView> implements MokamelPIshrafteClickListener {

    public List<MokamelPishrafteModel> mokamelPishrafteModels;
    public Context context;


    public MainActivityRecycler6Adapter(List<MokamelPishrafteModel> mokamelPishrafteModels, Context context) {
    ...
    @NonNull
    @Override
    public MainActivityRecycler6Adapter.CustomView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MainActivityRecycler6Adapter.CustomView customView, int i) {
