...
public class MainActivityRecycler2Adapter extends RecyclerView.Adapter<MainActivityRecycler2Adapter.CustomView> implements MokamelPIshrafteClickListener {

    public List<MokamelPishrafteModel> mokamelPishrafteModels;
    public Context context;


    public MainActivityRecycler2Adapter(List<MokamelPishrafteModel> mokamelPishrafteModels, Context context) {
    ...
    @NonNull
    @Override
    public MainActivityRecycler2Adapter.CustomView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MainActivityRecycler2Adapter.CustomView customView, int i) {
