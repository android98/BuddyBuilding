...
public class MainActivityRecycler7Adapter extends RecyclerView.Adapter<MainActivityRecycler7Adapter.CustomView> implements MokamelPIshrafteClickListener {

    public List<MokamelPishrafteModel> mokamelPishrafteModels;
    public Context context;


    public MainActivityRecycler7Adapter(List<MokamelPishrafteModel> mokamelPishrafteModels, Context context) {
    ...
    @NonNull
    @Override
    public MainActivityRecycler7Adapter.CustomView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MainActivityRecycler7Adapter.CustomView customView, int i) {
